  ...
  if (!startnextData && !(profile?.role === 'admin')) {
    ...
    return (
      <div className="relative w-full min-h-screen">
        {/* FONDO GLOBAL DE HOJAS VECTORIALES <LeafBackground />*/}
        

        {/* CONTENIDO FLOTANTE (z-10 para estar sobre el fondo) */}
        <div className="relative z-10 space-y-12 max-w-6xl mx-auto pb-12 pt-6">
            ...
            <div className="lg:col-span-5">
                <Card variant="premium" className="border-2 border-emerald-500/20 bg-card/95 backdrop-blur-sm sticky top-24">
                <CardContent className="pt-8">
                    ...
                    <AnimatePresence mode="wait">
                        {simVariant ? (
                        <motion.div key={simVariant.id} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-gradient-to-br from-emerald-600 to-emerald-600/20 p-4 rounded-2xl border border-emerald-200 shadow-lg text-center">
            ...
            <div className="lg:col-span-7 grid grid-cols-1 gap-4">
                ...
                <div 
                    ...
                    className={`
                        ...
                        ${isHighlighted 
                            ? 'bg-emerald-50/90 border-emerald-500 shadow-md scale-[1.02] ring-1 ring-emerald-500' 
                            : 'bg-card/80 backdrop-blur-sm border-border shadow-sm hover:shadow-md hover:border-emerald-300 hover:bg-white/90'
                        }
                    `}
                >

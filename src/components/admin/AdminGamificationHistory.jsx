                                ...
                                <TableRow key={item.id}>
                                    <TableCell>
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-xs text-muted-foreground">{item.profile?.email}</span>
                                        </div>
                                    </TableCell>
                                    <TableCell className="font-medium text-foreground">{item.action_name}</TableCell>
                                    <TableCell><span className="text-xs bg-background px-2 py-1 rounded-full">{item.action_type}</span></TableCell>
                                    <TableCell className="text-right font-mono text-emerald-600 font-bold">+{item.impact_credits_awarded}</TableCell>
                                    <TableCell className="text-xs text-muted-foreground">{format(new Date(item.action_date), 'PP p')}</TableCell>
                                </TableRow>
                            ))
                        )}
                    </TableBody>
